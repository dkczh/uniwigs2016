...
<section class="containerIndex">
	<a href="{$base_dir}tag/share-your-joy" class="img-responsive share-your-photos"></a>
				...
				success:function(data){
				    ...
				    for(i in data){
						if (data[i].isvideo) {
							...
							html += "<div class='box'><div class='hover-block'><div class='hover-bor'></div><div class='hover-op'></div></div><div class='pic'><a href='"+data[i].p_url+"'><img src='http://rvm.uniwigs.com/timthumb.php?src="+encodeURIComponent(data[i].src)+"&w=300'></a><p class='description'>"+data[i].title+"</p><p class='name'><span class='name_icon'><i class='icon-user'></i></span><span>"+data[i].author_name+"</span></p><p class='view_btn'><a href='"+data[i].p_url+"' class='view_btn'>VIEW PRODUCT ></a></p></div></div>";
						}
				    }
				    render($(html));
				},
