...
<form name="authorizeaim_form" id="authorizeaim_form" action="{$module_dir}validation.php" method="post">
	<span style="border: 1px solid #595A5E;display: block;padding: 2em;text-decoration: none;">
		<div class="card-wrapper" style="display:none"></div>
		<a id="click_authorizeaim" href="#" title="{l s='Pay with AuthorizeAIM' mod='authorizeaim'}" style="display: block;text-decoration: none; font-weight: bold;margin-bottom:15px">
			...
			<div id="aut2">				
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						<div class="row">
							<div class="col-sm-6">
							<select id="x_exp_date_m" name="x_exp_date_m" class="form-control not_uniform uk-form-large">{section name=date_m start=06 loop=13}
