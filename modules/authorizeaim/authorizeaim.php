...
class AuthorizeAIM extends PaymentModule
{
	...
	{	
		...
		if (Configuration::get('PS_SSL_ENABLED') || (!empty($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) != 'off') || Configuration::get('PS_SSL_ENABLED_EVERYWHERE'))
		{
			...
			$this->context->smarty->assign('total', $cart->getOrderTotal());
