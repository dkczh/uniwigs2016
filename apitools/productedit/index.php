...
$sql = ' SELECT SQL_CALC_FOUND_ROWS * from px_product_addition LIMIT 0,10 ';

$sqlrow = ' SELECT SQL_CALC_FOUND_ROWS id from px_product_addition ';
...
$smarty->assign('curl',PRODUCT_CURL);
