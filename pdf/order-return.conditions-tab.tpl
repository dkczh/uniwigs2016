	...
	<tbody>
		...
		<tr>
			<td class="center small white">
				<ul class="left">
					<li>{l s='Please include this return reference on your return package:' pdf='true'} {$order_return->id_order}</li>
				...
				<p style="margin-left: 20px;">
					<span>Return Address:</span><br>
					GEORGE HANN, 18305 E Valley Blvd., Ste C, La Puente, CA 91744
				</p>
			</td>
		</tr>
	</tbody>
