...
*}
<div id="idTab5" class="uk-margin-top">
						...
						<ul>
							...
							{if $is_logged}
								...
								<li>
									...
									<button class="usefulness_btn uk-button uk-button-mini" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
										<span>{l s='Yes' mod='productcomments'}</span>
									</button>
									<button class="usefulness_btn uk-button uk-button-mini" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
			...
			<div class="row">
				...
				<div class="new_comment_form_content col-xs-12 col-sm-6">
					...
					<div id="new_comment_form_footer">
						...
						<p class="fr">
							<button id="submitNewMessage" name="submitMessage" type="submit" class="uk-button uk-button-small">
