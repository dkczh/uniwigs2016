...
<div class="checkout-bar{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="javascript:;" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow" class="cart_a" data-uk-offcanvas="{literal}{target:'#quick-chart'}{/literal}">
			<span id="cartQuantity" class="ajax_cart_quantity">{$cart_qties}</span>
			</span>
		...
		{if !$PS_CATALOG_MODE}
			<div id="quick-chart" class="uk-offcanvas">
				<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
					<div class="cart_block {if $cart_qties == 0} unvisible{/if}">
						...
						<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
							...
							<p class="cart-buttons">
								<a id="button_order_cart" class="uk-button uk-button-primary" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
									<span>
					...
					<p class="cart_block_no_products{if $products} unvisible{/if}">
						{l s='YOUR CART IS EMPTY' mod='blockcart'}
					</p>
				</div>
			</div><!-- .cart_block -->
		{/if}
	...
	<div id="layer_cart">
		<div class="clearfix">
			<div class="layer_cart_product col-xs-12 col-md-6">
				...
				<span class="title">
					<i class="icon-check"></i>{l s='Product successfully added to cart' mod='blockcart'}
				</span>
		...
		<div class="button-container">
			<span class="continue uk-button uk-button-link" title="{l s='Continue shopping' mod='blockcart'}">
				<span>
