...
function findCombination(firstTime)
{
	...
	for (combination in combinations)
	{
		...
		if (nbAttributesEquals == choice.length)
		{
			...
			commented by Bruno at 2013.07.17*/
...
function updateDisplay()
{
	...
	else
	{
		...
		//$('#availability_statut:hidden').show(); //commented by Bruno at 2013.09.04, to remove show and hide performance
	...
	if (!selectedCombination['unavailable'])
	{
		...
		var attribut_wholesale_price_tmp = selectedCombination['wholesale_price'];
		if (attribut_wholesale_price_tmp <= 0) {
			attribut_wholesale_price_tmp = salonprice;
		}
...
//		$('#pretaxe_price_display').text(formatCurrency(productPricePretaxed, currencyFormat, currencySign, currencyBlank));
		$('#retail_price_display').text(formatCurrency(productPriceWithoutReduction2, currencyFormat, currencySign, currencyBlank));
//		$('#ecotax_price_display').text(formatCurrency(selectedCombination['ecotax'], currencyFormat, currencySign, currencyBlank));

		if (attribut_wholesale_price_tmp > 0) {
			$('#salon_price_display').text(formatCurrency(attribut_wholesale_price_tmp, currencyFormat, currencySign, currencyBlank));
		}
	}
