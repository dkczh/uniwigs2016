...
{if !isset($email_create)}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box uk-form uk-form-horizontal">
				<h3 class="page-subheading">{l s='Create an account'}</h3>
				<div class="form_content clearfix">
					<p>{l s='Please enter your email address to create an account.'}</p>
					<div class="uk-alert uk-alert-danger" id="create_account_error" style="display:none" data-uk-alert><a href="" class="uk-alert-close uk-close"></a></div>
					<div class="form-group uk-form-row">
						<label for="email_create" class="uk-form-label">{l s='Email address'}</label>
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box uk-form uk-form-horizontal">
				<h3 class="page-subheading">{l s='Already registered?'}</h3>
				<div class="form_content clearfix">
					<div class="form-group uk-form-row">
						<label for="email" class="uk-form-label">{l s='Email address'}</label>
						<div class="uk-form-controls">
					...
					<div class="form-group uk-form-row">
						<label for="passwd" class="uk-form-label">{l s='Password'}</label>
						<div class="uk-form-controls">
							<input class="is_required validate account_input form-control" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="" />
						</div>
					</div>
					<p class="lost_password form-group uk-form-row"><a href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow">{l s='Forgot your password?'}</a></p>
					<p class="submit">
						{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
	...
	{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std uk-form uk-form-horizontal clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group uk-form-row">
						<label for="guest_email" class="uk-form-label">{l s='Email address'} <sup>*</sup></label>
						<div class="uk-form-controls">
					...
					<div class="form-group uk-form-row date-select">
					...
					{foreach from=$dlv_all_fields item=field_name}
						...
						{elseif $field_name eq "vat_number"}
							<div id="vat_number" style="display:none;">
								<div class="form-group uk-form-row">
									<label for="vat-number" class="uk-form-label">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
									<div class="uk-form-controls">
						...
						{elseif $field_name eq "address2"}
							<div class="form-group uk-form-row is_customer_param">
						...
						{elseif $field_name eq "postcode"}
							...
							<div class="required postcode form-group uk-form-row">
						...
						{elseif $field_name eq "State:name"}
							...
							<div class="required id_state select form-group uk-form-row">
					...
					{if $dniExist eq false}
						<div class="required form-group uk-form-row dni">
							<label for="dni" class="uk-form-label">{l s='Identification number'} <sup>*</sup></label>
							<div class="uk-form-controls">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						{elseif $field_name eq "dni"}
						{assign var=dniExist value=true}
						<div class="required form-group uk-form-row dni_invoice">
						...
						{/foreach}
						{if !$postCodeExist}
						<div class="required postcode_invoice form-group uk-form-row unvisible">
							<label for="postcode_invoice" class="uk-form-label">{l s='Zip/Postal Code'} <sup>*</sup></label>
							<div class="uk-form-controls">
						...
						{/if}
						{if !$stateExist}
						<div class="required id_state_invoice form-group uk-form-row unvisible">
							<label for="id_state_invoice" class="uk-form-label">{l s='State'} <sup>*</sup></label>
							<div class="uk-form-controls">
								<select name="id_state_invoice" id="id_state_invoice" class="form-control">
									<option value="">-</option>
...
{else}
	...
	{/if}-->
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box uk-form uk-form-horizontal">
		...
		<div class="account_creation">
			...
			<div class="required form-group uk-form-row">
				<label for="customer_firstname" class="uk-form-label">{l s='First name'} <sup>*</sup></label>
				<div class="uk-form-controls">
			...
			<div class="required form-group uk-form-row">
				<label for="customer_lastname" class="uk-form-label">{l s='Last name'} <sup>*</sup></label>
				<div class="uk-form-controls">
			...
			<div class="required password form-group uk-form-row">
		...
		{if $b2b_enable}
			<div class="account_creation">
				...
				<p class="form-group uk-form-row">
					<label for="" class="uk-form-label">{l s='Company'}</label>
					<div class="uk-form-controls">
						<input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
					</div>
				</p>
				<p class="form-group uk-form-row">
					<label for="siret" class="uk-form-label">{l s='SIRET'}</label>
					<div class="uk-form-controls">
						<input type="text" class="form-control" id="siret" name="siret" value="{if isset($smarty.post.siret)}{$smarty.post.siret}{/if}" />
					</div>
				</p>
				<p class="form-group uk-form-row">
					<label for="ape" class="uk-form-label">{l s='APE'}</label>
					<div class="uk-form-controls">
						<input type="text" class="form-control" id="ape" name="ape" value="{if isset($smarty.post.ape)}{$smarty.post.ape}{/if}" />
					</div>
				</p>
				<p class="form-group uk-form-row">
					<label for="website" class="uk-form-label">{l s='Website'}</label>
					<div class="uk-form-controls">
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				...
				{foreach from=$dlv_all_fields item=field_name}
					...
					{elseif $field_name eq "firstname"}
						<p class="required form-group uk-form-row">
							<label for="firstname" class="uk-form-label">{l s='First name'} <sup>*</sup></label>
							<div class="uk-form-controls">
					...
					{elseif $field_name eq "address2"}
						<p class="form-group uk-form-row is_customer_param">
							<label for="address2" class="uk-form-label">{l s='Address (Line 2)'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
							<div class="uk-form-controls">
							<input type="text" class="form-control" name="address2" id="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{/if}" />
					...
					{elseif $field_name eq "postcode"}
						{assign var='postCodeExist' value=true}
						<p class="required postcode form-group uk-form-row">
							<label for="postcode" class="uk-form-label">{l s='Zip/Postal Code'} <sup>*</sup></label>
							<div class="uk-form-controls">
							<input type="text" class="validate form-control" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{/if}"/>
						</div>
					...
					{elseif $field_name eq "city"}
						...
						<!-- if customer hasn't update his layout address, country has to be verified but it's deprecated -->
					{elseif $field_name eq "Country:name" || $field_name eq "country"}
						<p class="required select form-group uk-form-row">
							<label for="id_country" class="uk-form-label">{l s='Country'} <sup>*</sup></label>
							<div class="uk-form-controls">
							<select name="id_country" id="id_country" class="form-control">
								<option value="">-</option>
					...
					{elseif $field_name eq "State:name" || $field_name eq 'state'}
						{assign var='stateExist' value=true}
						<p class="required id_state select form-group uk-form-row">
							<label for="id_state" class="uk-form-label">{l s='State'} <sup>*</sup></label>
							<div class="uk-form-controls">
							<select name="id_state" id="id_state" class="form-control">
								<option value="">-</option>
				...
				{/foreach}
				{if $postCodeExist eq false}
					<p class="required postcode form-group uk-form-row unvisible">
						<label for="postcode" class="uk-form-label">{l s='Zip/Postal Code'} <sup>*</sup></label>
						<div class="uk-form-controls">
						<input type="text" class="validate form-control" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{/if}"/>
					</div>
				...
				{/if}
				{if $stateExist eq false}
					<p class="required id_state select unvisible form-group uk-form-row">
						<label for="id_state" class="uk-form-label">{l s='State'} <sup>*</sup></label>
						<div class="uk-form-controls">
						<select name="id_state" id="id_state" class="form-control">
							<option value="">-</option>
				...
				{/if}
				<p class="textarea form-group uk-form-row">
				...
				<p class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group uk-form-row">
					<label for="phone_mobile" class="uk-form-label">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
					<div class="uk-form-controls">
					<input type="text" class="form-control" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
				</div>
				...
				{/if}
				<p class="required form-group uk-form-row" id="address_alias">
					<label for="alias" class="uk-form-label">{l s='Assign an address alias for future reference.'} <sup>*</sup></label>
