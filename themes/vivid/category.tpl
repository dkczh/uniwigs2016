    ...
    {if $category->id == '102'}
        ...
        <section class="containerIndex">
            <section class="category-home">
                ...
                <div class="uk-margin-top">
                    <a href="{$base_dir}tag/celebrity-hairstyles"><img src="{$img_dir}category/human-hair/star.jpg" alt="real human hair" class="img-responsive"></a>
                </div>
                <div class="uk-margin-top">
            ...
            <section class="category-home">
                ...
                <div class="clearfix">
                    <div class="col-md-5 col-sm-11 col-sm-offset-2 col-md-offset-1 uk-margin-large-top">
                        <div class="text-detail text-detail-bottom">
                            <h3><a href="{$base_dir}tag/classic-wigs-synthetic-wigs">classic</a></h3>
                            <h5>The classic will last forever!</h5>
                        </div>
                        <a class="pull-left img-responsive" href="{$base_dir}tag/classic-wigs-synthetic-wigs"><img src="{$img_dir}category/synthetic-wigs/classic_wigs.jpg" alt=""></a>
                    </div>
                    <div class="uk-margin-large-top col-md-4 col-sm-8 col-sm-offset-4 col-md-offset-2">
                        <div class="text-detail text-detail-top pull-left">
                            <h3><a href="{$base_dir}tag/trendy-wigs">trendy</a></h3>
                            <h5>Wanna become trendy? Let's start with the hair!</h5>
                        </div>
                        <a class="pull-left img-responsive" href="{$base_dir}tag/trendy-wigs"><img src="{$img_dir}category/synthetic-wigs/trendy_wigs.jpg" alt=""></a>
                    </div>
                </div>
                <div class="category-banner clearfix">
                    ...
                    <div class="col-md-4 uk-margin-large-top">
                        <a href="{$base_dir}tag/clearance-synthetic-wigs" class="synthetic_clearnce text-center">
                            <h2>clearnce</h2>
                     ...
                     {if isset($SyntheticWigsHotList)}
                         <div class="cagegory_topsale title-hr">
                             ...
                             <ul class="cagegory_products_list row uk-margin-top">
                                 ...
                                 <li>
                                     <div class="product-container">
                                         <a href="{$category->id}--{$p['id_product']}-{$p['link_rewrite']}.html" class="prodcut_a" title="{$p['name']}">
                                             <img src="/{$p['id_image']}-home_default/{$p['link_rewrite']}.jpg" alt="{$p['name']}" title="{$p['name']}" class="img-responsive"/>
                                         </a>
                                         <div class="text-center">
                                             <p class="name uk-margin-small-top">
        ...
        <section class="containerIndex" itemscope itemtype="http://schema.org/SearchResultsPage">
            <section class="category-home">
                <div class="cargory_banner">
                    <a href="{$base_dir}tag/diy-dyed-extensions"><img src="{$img_dir}category/extensions/diy-dyed.jpg" alt="Diy Dyed"  class="img-responsive"></a>
                </div>
                <ul class="row uk-margin-top">
                    <li class="col-md-6 col-sm-6">
                        <a href="{$base_dir}108-clip-in-hair-extensions">
                            <img src="{$img_dir}category/extensions/clip-in-hair.jpg" alt="" class="img-responsive">
                        </a>
                        <h3 class="text-center">CLIP IN hair extensions</h3>
                        <h5 class="text-center uk-margin-small-top"><a href="{$base_dir}clip-in-hair-extensions">shop now ></a></h5>
                    </li>
                    <li class="col-md-6 col-sm-6">
                        <a href="{$base_dir}tag/invisible-uni-extensions">
                            <img src="{$img_dir}category/extensions/uni-hiar.jpg" alt="" class="img-responsive">
                        </a>
                        <h3 class="text-center">Uni extensions</h3>
                        <h5 class="text-center uk-margin-small-top"><a href="{$base_dir}featured/invisible-uni-extensions">shop now ></a></h5>
                    </li>
                </ul>
                <div class="uk-margin-top">
                    <a href="{$base_dir}tag/ombre-hair-extensions"><img src="{$img_dir}category/extensions/colorful-hair.jpg" alt="Colorful Hair" class="img-responsive"></a>
                </div>
            ...
            <section class="category-home">
                ...
                <ul class="row uk-margin-top">
                    <li class="col-md-6 col-sm-6">
                        ...
                        <h5 class="text-center uk-margin-small-top"><a href="{$base_dir}tag/mono-hair-pieces">shop now ></a></h5>
                        <a href="{$base_dir}tag/mono-hair-pieces">
