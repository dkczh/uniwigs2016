<div id="opc_new_account" class="opc-main-block">
	...
	<ul class="register_login" data-uk-switcher="{literal}{connect:'#register_login'}{/literal}">
		<li><a href="#login_form_content" class="uk-button">{l s='Log in'}</a></li>
		<li><a href="#register_form_content" id="openLoginFormBlock" class="uk-button">{l s='register'}</a>
	</ul>
	<ul id="register_login" class="uk-switcher">
	    <li>
				...
				<fieldset>
					<div id="login_form_content">
						...
						<div class="submit">
							...
							<button type="submit" id="SubmitLogin" name="SubmitLogin" class="uk-button uk-button-primary"><span><i class="icon-lock left"></i>{l s='Sign in'}</span></button>
						</div>
					</div>
				</fieldset>
			</form>
	    			...
	    			<div class="box">
	    				...
	    				<div id="opc_account_form" class="unvisible">
	    					...
	    					<div class="submit opc-add-save clearfix">
	    						...
	    						<button type="submit" name="submitAccount" id="submitAccount" class="uk-button uk-button-primary" onClick="_gas.push(['_trackEvent','onclick','click','buynow_submit']);"><span>{l s='Save'}<i class="icon-chevron-right right"></i></span></button>
