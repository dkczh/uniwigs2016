			...
			<div id="aut2">				
				...
				<div class="uk-form-row">
					...
					<div class="uk-form-controls">
						...
						<div id="cart">
							<input type="button" id="asubmit" value="{l s='Validate order' mod='authorizeaim'}" class="uk-button uk-button-primary uk-margin-top" onClick="_gas.push(['_trackEvent','onclick','click','SubmitOrder']);"/>
						</div>
					</div>
				</div>		
			</div>		
