	...
	{if $id_customer|intval neq 0}
		{*<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				...
				<p class="submit">
                    <button id="submitWishlist" class="uk-button uk-button-primary" type="submit" name="submitWishlist">
		...
		{if $wishlists}
			<div id="block-history" class="block-center uk-overflow-container">
