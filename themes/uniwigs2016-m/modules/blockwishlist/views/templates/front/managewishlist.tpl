...
{if $products}
    {if !$refresh}
       ...
       {*<ul class="clearfix display_list">
        ...
        <p class="submit">
            <div id="showSendWishlist" class="uk-margin-bottom">
                <a class="uk-button" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
                        ...
                        <div>
                            <div class="product_infos">
                                ...
                                <p id="s_title" class="product-name">
                                    {$product.name|truncate:80:'...'|escape:'html':'UTF-8'}
                                ...
                                <div class="btn_action uk-margin-top">
                                    <a class="uk-button"  href="javascript:;" onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Save' mod='blockwishlist'}">
    ...
    {if !$refresh}
        ...
        <a id="hideSendWishlist" class="uk-button button_account btn icon"  href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" rel="nofollow" title="{l s='Close this wishlist' mod='blockwishlist'}">
            <i class="icon-remove"></i>
        </a>
            <fieldset>
