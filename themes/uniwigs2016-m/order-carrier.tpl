	...
	{else}
		...
		{else}
			<div class="delivery_options_address">
						...
						<div class="delivery_options">
							{foreach $option_list as $key => $option}
								<div class="delivery_option {if ($option@index % 2)}alternate_{/if}item">
									<label>
										<table class="resume uk-table table table-bordered{if !$option.unique_carrier} hide{/if}">
											<tr>
										...
										{if !$option.unique_carrier}
											<table class="delivery_option_carrier{if isset($delivery_option[$id_address]) && $delivery_option[$id_address] == $key} selected{/if} resume uk-table table table-bordered{if $option.unique_carrier} hide{/if}">
												<tr>
													{if !$option.unique_carrier}
				...
				{if $opc}
					<p class="carrier_title uk-margin-small-top">{l s='Leave a message'}</p>
					<div>
