...
<h1 id="cart_title" class="text-center uk-margin-bottom">{l s='Secure checkout'}
			...
			<tbody>
				...
				{if $use_taxes}
					{if $priceDisplay}
						<tr class="cart_total_price">
							...
							<td colspan="2" class="text-left uk-text-bold">{if $display_tax_label}{l s='Total products (tax excl.)'}{else}{l s='Total products'}{/if}</td>
					...
					{else}
						<tr class="cart_total_price">
							...
							<td colspan="2" class="text-left uk-text-bold">{if $display_tax_label}{l s='Total products (tax incl.)'}{else}{l s='Total products'}{/if}</td>
				...
				{else}
					<tr class="cart_total_price">
						...
						<td colspan="2" class="text-left uk-text-bold">{l s='Total products'}</td>
						<td colspan="1" class="price" id="total_product">{displayPrice price=$total_products}</td>
					</tr>
				{/if}
				...
				{if $total_shipping_tax_exc <= 0 && (!isset($isVirtualCart) || !$isVirtualCart) && $free_ship}
					<tr class="cart_total_delivery{if !$opc && (!isset($cart->id_address_delivery) || !$cart->id_address_delivery)} unvisible{/if}">
						<td colspan="2" class="text-left uk-text-bold">{l s='Total shipping'}</td>
					...
					{if $use_taxes && $total_shipping_tax_exc != $total_shipping}
						{if $priceDisplay}
							<tr class="cart_total_delivery{if $total_shipping_tax_exc <= 0} unvisible{/if}">
								<td colspan="2" class="text-left uk-text-bold">{if $display_tax_label}{l s='Total shipping (tax excl.)'}{else}{l s='Total shipping'}{/if}</td>
						...
						{else}
							<tr class="cart_total_delivery{if $total_shipping <= 0} unvisible{/if}">
								<td colspan="2" class="text-left uk-text-bold">{if $display_tax_label}{l s='Total shipping (tax incl.)'}{else}{l s='Total shipping'}{/if}</td>
				...
				{if $use_taxes && $show_taxes && $total_tax != 0 }
					{if $priceDisplay != 0}
					<tr class="cart_total_price">
						<td colspan="2" class="text-left uk-text-bold">{if $display_tax_label}{l s='Total (tax excl.)'}{else}{l s='Total'}{/if}</td>
						<td colspan="1" class="price" id="total_price_without_tax">{displayPrice price=$total_price_without_tax}</td>
					</tr>
					{/if}
					<tr class="cart_total_tax">
						<td colspan="2" class="text-left uk-text-bold">{l s='Tax'}</td>
...
{else}
	...
	<div id="order-detail-content" class="table_block table-responsive">
		<table id="cart_summary" class="table uk-table {if $PS_STOCK_MANAGEMENT}stock-management-on{else}stock-management-off{/if}">
			<thead>
				<tr>
					<th class="cart_product first_item">{l s='Product'}</th>
					<th class="cart_description item">{l s='Description'}</th>
					<th class="cart_unit item text-center">{l s='Unit price'}</th>
