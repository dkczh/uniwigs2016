...
<div class="box">
    ...
    {else}
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std uk-form uk-form-horizontal">
            <fieldset>
                <div class="clearfix">
                ...
                <div class="required form-group uk-form-row">
                    <label for="firstname" class="required uk-form-label">
                        {l s='First name'}
                    </label>
                ...
                <div class="required form-group uk-form-row">
                    <label for="lastname" class="required uk-form-label">
                        {l s='Last name'}
                    </label>
                    <div class="uk-form-controls">
                ...
                <div class="required form-group uk-form-row">
                    <label for="email" class="required uk-form-label">
                        {l s='E-mail address'}
                    </label>
                    <div class="uk-form-controls">
                ...
                <div class="required form-group uk-form-row">
                    <label for="old_passwd" class="required uk-form-label">
                ...
                <div class="password form-group uk-form-row">
                ...
                <div class="password form-group uk-form-row">
                    <label for="confirmation" class="uk-form-label">
                        {l s='Confirmation'}
                    </label>
                    <div class="uk-form-controls">
