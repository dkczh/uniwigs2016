...
{else}
	<div id="carrier_area" class="opc-main-block col-xl-12">
		<h1 class="page-heading step-num"><span>Step 2:</span> {l s='Delivery methods'}</h1>
...
<div class="order_carrier_content box">
	...
	{else}
		...
		{if isset($isVirtualCart) && $isVirtualCart}
			<p class="alert alert-warning">{l s='No carrier is needed for this order.'}</p>
		{else}
			<div class="delivery_options_address uk-margin-small-bottom">
				...
				{if $opc}
					...
					<div>
						...
						<textarea class="form-control uk-margin-small-top" cols="120" rows="2" name="message" id="message">{strip}
