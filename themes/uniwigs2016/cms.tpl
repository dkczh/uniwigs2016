...
{if isset($cms) && !isset($cms_category)}
	...
	<div class="rte doc-con uk-table{if $content_only} content_only{/if}">
		{$cms->content}
	</div>
	{if $cms->meta_title == 'How to Videos'}
		<script type="text/javascript" src="/themes/uniwigs2016/js/lightbox.js"></script>
	{/if}
	{if $cms->meta_title == 'UniWigs Wigs' or $cms->meta_title == 'UniWigs Hair Extensions' or $cms->meta_title == 'Others'}
