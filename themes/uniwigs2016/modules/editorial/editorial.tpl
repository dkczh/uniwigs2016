...
<div class="uk-margin-large-top">
	<a href="{$base_dir}tag/toppers"><img src="{$base_dir}themes/uniwigs2016-m/img/milanoo_blank.gif" original="{$base_dir}themes/uniwigs2016/img/index/hair-loss-15off.jpg" alt="Hair Loss"></a>
</div>
</div>
</div>
</div>
