...
{if $PS_SC_TWITTER || $PS_SC_FACEBOOK || $PS_SC_GOOGLE || $PS_SC_PINTEREST}
	...
	<p class="socialsharing_product list-inline no-print">
		{if $PS_SC_TWITTER}
			<button data-type="twitter" type="button" class="uk-button uk-button-small btn-twitter social-sharing">
				<i class="icon-twitter"></i> {l s="Tweet" mod='socialsharing'}
				<!-- <img src="{$link->getMediaLink("`$module_dir`img/twitter.gif")}" alt="Tweet" /> -->
			</button>
		{/if}
		{if $PS_SC_FACEBOOK}
			<button data-type="facebook" type="button" class="uk-button uk-button-small btn-facebook social-sharing">
		...
		{/if}
		{if $PS_SC_GOOGLE}
			<button data-type="google-plus" type="button" class="uk-button uk-button-small btn-google-plus social-sharing">
		...
		{/if}
		{if $PS_SC_PINTEREST}
			<button data-type="pinterest" type="button" class="uk-button uk-button-small btn-pinterest social-sharing">
