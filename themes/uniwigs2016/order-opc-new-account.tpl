<div id="opc_new_account" class="opc-main-block col-xl-12">
	<div id="opc_new_account-overlay" class="opc-overlay" style="display: none;"></div>
	<h1 class="page-heading step-num"><span>Step 1:</span> {l s='Account'}</h1>
	<div class="row sign-hide">
		<div class="col-sm-6">
			<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box uk-form uk-form-stacked">
				<fieldset>
					...
					<div id="login_form_content">
						...
						<div class="form-group uk-form-row">
							...
							<div class="uk-form-controls">
								<input type="email" class="form-control validate uk-form-large" id="login_email" name="email" data-validate="isEmail" />
							</div>
						</div>
						<div class="form-group uk-form-row">
							<label for="login_passwd" class="uk-form-label">{l s='Password'}</label>
							<div class="uk-form-controls">
								<input class="form-control validate uk-form-large" type="password" id="login_passwd" name="login_passwd" data-validate="isPasswd" />
							</div>
						</div>
		...
		<div class="col-sm-6">
			<h3 class="page-subheading">{l s='New Customer'}</h3>
			<p class="uk-margin-bottom">Create a permanent account and use it for checkout</p>
			<div class="submit">
				<a href="javascript:;" class="button btn btn-default button-medium register_show"><span>Register</span></a>
			</div>
		</div>
	</div>
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std uk-form uk-form-horizontal" autocomplete="on" autofill="on" style="display:none">
		<fieldset>
			<div class="box">
				...
				<div id="opc_account_form" class="unvisible">
					...
					<div class="select form-group date-select uk-form-row">
						...
						<div class="row uk-form-controls">
							<div class="col-xs-4">
								<select id="days" name="days" class="form-control not_uniform">
									<option value="">--</option>
							...
							<div class="col-xs-4">
								<select id="months" name="months" class="form-control not_uniform">
									<option value="">--</option>
							...
							<div class="col-xs-4">
								<select id="years" name="years" class="form-control not_uniform">
									<option value="">--</option>
					...
					<div class="required select form-group uk-form-row">
						...
						<div class="uk-form-controls">
							<select name="id_country" id="id_country" class="form-control not_uniform">
					...
					<div id="opc_invoice_address" class="is_customer_param">
						...
						<div class="required form-group uk-form-row">
							...
							<div class="uk-form-controls">
								<select name="id_country_invoice" id="id_country_invoice" class="form-control not_uniform">
									<option value="">-</option>
									{foreach from=$countries item=v}
						...
						<div class="required id_state_invoice form-group uk-form-row" style="display:none;">
							...
							<div class="uk-form-controls">
								<select name="id_state_invoice" id="id_state_invoice" class="form-control not_uniform">
									<option value="">-</option>
								</select>
							</div>
						</div>
