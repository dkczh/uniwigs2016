										...
										{/if}
											...
											<div class="attribute_list">
												{if ($group.group_type == 'select')}
													...
													<a href="#attributes_hairline" data-uk-modal class="highslide">Clip In</a>
													<div id="attributes_hairline" class="uk-modal">
														 <div class="uk-modal-dialog">
													        <a class="uk-modal-close uk-close"></a>
												...
												{elseif ($group.group_type == 'color')}
													...
													<p class="text-primary"><small>Celebrity color can only be received by choosing "Celebrity-Style+ 28 days"; you will receive the single color if you select the others.</small></p>
