...
class OrderCore extends ObjectModel
{
    ...
    */
    ...
    public function getProductsDetailx()
    {/* echo 'xxxx';
		exit; */
    ...
    {	
		...
		/* echo '111';
		exit; */
        return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS("SELECT SQL_NO_CACHE *,CONCAT(cl.`link_rewrite`,'\/',p.`id_product`,'-',pl.`link_rewrite`) as mylink
