    ...
    public static function write($type, $resource, $filename)
    {
        ...
        switch ($type) {
            ...
            default:
				...
				//更改ps1.6缩略图片生产机制 一次生成3个店铺所需的图片
				if(strstr($filename,"_1.jpg")){
					$filename1 =str_replace('_1.jpg','_3.jpg',$filename);
					$success = imagejpeg($resource, $filename1, (int)$quality);
					$filename2 =str_replace('_1.jpg','_2.jpg',$filename);
					$success = imagejpeg($resource, $filename2, (int)$quality);	
					$filename3 =str_replace('_1.jpg','_0.jpg',$filename);
					$success = imagejpeg($resource, $filename3, (int)$quality);
				}
				if(strstr($filename,"_2.jpg")){
					$filename1 =str_replace('_2.jpg','_3.jpg',$filename);
					$success = imagejpeg($resource, $filename1, (int)$quality);
					$filename2 =str_replace('_2.jpg','_1.jpg',$filename);
					$success = imagejpeg($resource, $filename2, (int)$quality);	
					$filename3 =str_replace('_2.jpg','_0.jpg',$filename);
					$success = imagejpeg($resource, $filename3, (int)$quality);
				}
				if(strstr($filename,"_3.jpg")){
					$filename1 =str_replace('_3.jpg','_1.jpg',$filename);
					$success = imagejpeg($resource, $filename1, (int)$quality);
					$filename2 =str_replace('_3.jpg','_2.jpg',$filename);
					$success = imagejpeg($resource, $filename2, (int)$quality);	
					$filename3 =str_replace('_3.jpg','_0.jpg',$filename);
					$success = imagejpeg($resource, $filename3, (int)$quality);
				}
				if(strstr($filename,"_0.jpg")){
					$filename1 =str_replace('_0.jpg','_3.jpg',$filename);
					$success = imagejpeg($resource, $filename1, (int)$quality);
					$filename2 =str_replace('_0.jpg','_2.jpg',$filename);
					$success = imagejpeg($resource, $filename2, (int)$quality);	
					$filename3 =str_replace('_0.jpg','_1.jpg',$filename);
					$success = imagejpeg($resource, $filename3, (int)$quality);
				}
