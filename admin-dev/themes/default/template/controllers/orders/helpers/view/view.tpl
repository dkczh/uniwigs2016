	...
	<div class="row">
		<div class="col-lg-7">
			<div class="panel">
				...
				<!-- Tab content -->
				<div class="tab-content panel" style="overflow-y: inherit;">
					{$HOOK_CONTENT_ORDER}
					<!-- Tab status -->
...
<hr>
				...
				<td style="padding: 10px;">日期</td>
				<td style=" width:50px;padding: 10px;">付款</td>
				<td style=" width:80px; padding: 10px;">状态</td>
				<td style="padding: 10px;">有效</td>
				</tr>
				</thead>
				<tbody>
	...
	<a href="?controller=AdminOrders&id_order={$co['id_order']}&vieworder&token={$token}"
	class="btn btn-default btn-block">{$co['id_order']}</a>
				
				
				</td>
				<td style="padding: 5px;">{$co['date_add']}</td>
				<td style="padding: 5px;">{$co['total_paid']|string_format:"%.2f"}</td>
				<td style="padding: 5px;">{$co['name']}</td>
				<td style="padding: 5px;">{$co['STATUS']}</td>
				...
				<div class="panel-heading">
					...
					<div class="panel panel-highlighted">
						<div class="message-item">
							{foreach  $customer_thread_message  as  $cm}
								...
								<div class="message-body">
									...
									<p class="message-item-text">
										{$cm['message']|escape:'html':'UTF-8'|nl2br}
									</p>
								</div>
							{/foreach}
							{*原有的订单信息*}
	...
	{*自定义订单留言信息展示 customer message*}	
				...
				{if $cm['id_employee']==0}
				<td style="color:red">{$cm['message']}</td>
				<td style="color:red">顾客留言</td>
				<td>{$cm['date_add']}</td>
				{else}
				<td>{$cm['message']}</td>
				<td >管理员回复</td>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tr id="total_products">
											...
											<td class="amount text-right nowrap" style="font-weight: bold;color: #e0287d;">
